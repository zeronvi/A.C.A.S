// ==UserScript==
// @name        🏆 [#1 Chess Cheat] A.C.A.S Chess Cheat for Zeronvi.7m.pl
// @name:en     🏆 [#1 Chess Cheat] A.C.A.S Chess Cheat for Zeronvi.7m.pl
...
// @homepageURL http://zeronvi.7m.pl/A.C.A.S/*
...
const backendURLs = {
    'production': 'http://zeronvi.7m.pl/A.C.A.S/',
